...
# Adaire Chat Onboarding Guide

## Open Adaire Chat and on the login screen, tap Sign in manually.
![User guide screenshot](https://github.com/helloadaire/AdaireChatSynapseInterception/blob/main/assets/user-guide-01.png?raw=true)

## Tap Change account provider.
![User guide screenshot](https://github.com/helloadaire/AdaireChatSynapseInterception/blob/main/assets/user-guide-02.png?raw=true)

## Select “Adaire Chat” as the account provider.
![User guide screenshot](https://github.com/helloadaire/AdaireChatSynapseInterception/blob/main/assets/user-guide-03.png?raw=true)


## Enter the provider domain:

### synapse.production-messaging.adaire.dev

![User guide screenshot](https://github.com/helloadaire/AdaireChatSynapseInterception/blob/main/assets/user-guide-04.png?raw=true)


## Tap Continue.
![User guide screenshot](https://github.com/helloadaire/AdaireChatSynapseInterception/blob/main/assets/user-guide-05.png?raw=true)
